...
<div class="aiovg-thumbnail">
    <a href="<?php echo esc_url( $permalink ); ?>" class="aiovg-responsive-container" style="padding-bottom: <?php esc_attr_e( $attributes['ratio'] ); ?>;">
        <img src="<?php echo esc_url( $image ); ?>" class="aiovg-responsive-element" />
    </a>
    
    <div class="aiovg-caption">
        <div class="aiovg-title">
            <a href="<?php echo esc_url( $permalink ); ?>" class="aiovg-link-title"><?php esc_html_e( $term->name ); ?></a>
        </div>
            
        <?php if ( ! empty( $attributes['show_description'] ) && $term->description ) : ?>
            <div class="aiovg-description"><?php esc_html_e( $term->description ); ?></div>
        <?php endif; ?>
        
        <?php if ( ! empty( $attributes['show_count'] ) ) : ?>
            <div class="aiovg-count aiovg-text-muted">
                <span class="aiovg-icon-film"></span>
                <?php printf( __( '%d videos', 'all-in-one-video-gallery' ), $term->count ); ?>
            </div>
        <?php endif; ?>
    </div>            			
</div>